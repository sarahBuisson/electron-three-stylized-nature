...
A cross-hatching GLSL shader material for React Three Fiber that creates a stylized pen-and-ink engraving effect.
...
- **Paper texture overlay** for authentic engraving appearance
...
```tsx
import { EngravingMaterial } from './shaders/engraving/EngravingMaterial';
...
### Default
Clean technical engraving style with blue ink:
```tsx
<EngravingMaterial
  ambientWeight={0.08}
  diffuseWeight={1.0}

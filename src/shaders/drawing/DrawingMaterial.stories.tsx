...
import { DrawingMaterial, type DrawingMaterialProps } from './DrawingMaterial';

/**
 * # DrawingMaterial
 *
 * A cross-hatching GLSL shader material that creates a stylized pen-and-ink drawing effect.
 ...
 */
const meta = {
  title: 'Graphics/Materials/DrawingMaterial',
  component: DrawingMaterial,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'A stylized shader material for creating pen-and-ink drawing effects with cross-hatching.',
      },
    },
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof DrawingMaterial>;

export default meta;
type Story = StoryObj<typeof meta>;

// Wrapper component for stories
const DrawingMaterialScene = (args: DrawingMaterialProps) => {
  return (
...
/**
 * Default preset with clean technical drawing style and blue ink.
 */
export const Default: Story = {
  ...
  render: (args) => <DrawingMaterialScene {...args} />,
};

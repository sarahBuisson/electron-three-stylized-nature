...
const DrawingShaderMaterial = shaderMaterial(
  // Uniforms
  {
    showOutline: 0,
    ambientWeight: 0.08,
...
declare module '@react-three/fiber' {
  ...
  interface ThreeElements {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    drawingShaderMaterial: any;
  }
}

export interface DrawingMaterialProps {
...
/**
 * DrawingMaterial - A cross-hatching shader material for stylized rendering
 ...
 * ```
 */
export const DrawingMaterial: React.FC<DrawingMaterialProps> = ({
  ambientWeight = 0.08,
  diffuseWeight = 1.0,
  rimWeight = 0.46,
  specularWeight = 1.0,
  ...
  hatchTextures=
     [
         useTexture( './level/drawing/hatch_0.jpg' ) ,
      useTexture( './level/drawing/hatch_1.jpg'),
      useTexture( './level/drawing/hatch_2.jpg'),

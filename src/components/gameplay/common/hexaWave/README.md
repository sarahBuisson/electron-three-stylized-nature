# HexagonalWave - Component Documentation
...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| `particleSize` | number | 0.2 | Taille de chaque particule |
| `particleColor` | string | '#00ff88' | Couleur des particules (hex) |
...
- [ ] Particles avec formes custom (au lieu de cercles)
